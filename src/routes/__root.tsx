...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  // Hanya menampilkan error di console (komputer lokal), tidak dikirim ke Lovable
  console.error(error);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SIPPKBG — Sistem Pemeriksaan Kerusakan Bangunan Gedung" },
      { name: "description", content: "Aplikasi pemeriksaan dan penanganan kerusakan bangunan gedung." },
    ],
    links: [
